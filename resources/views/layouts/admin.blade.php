...
<body>
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand" href="site.blade..php">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                     href="site.blade..php" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
    ...
    <!--chartis chart-->
    <script src="{{ asset('/admin_assets/assets/libs/chartist/dist/chartist.min.js') }}"></script>
    <script src="{{ asset('/admin_assets/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}"></script>
    <script src="{{ asset('/admin_assets/dist/js/pages/dashboards/dashboard1.js') }}"></script>
</body>
